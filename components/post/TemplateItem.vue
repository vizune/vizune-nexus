...
<template>
    <div class="text-left mb-8 flex flex-col h-full">
        ...
        <img :src="asset" class="border-t-8 border-black mb-1 pt-1" v-if="asset" />
        ...
        <div class="flex flex-col xl:flex-row justify-center gap-1 mt-1">
            ...
            <a :href="fields.repoUrl" target="_blank" class="button w-full">
                <div class="flex justify-between items-center">
